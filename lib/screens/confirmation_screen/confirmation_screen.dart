                  ...
                  builder: (context, provider, child) {
                    return Column(
                      ...
                      children: [
                        ...
                        //Input
                        CollectionListTile(
                          //gif de imagen en pantalla de confirmacion
                          image: 'bafkreifgzzsizw6rsfapuww642vtivvsst5qsxrsm62mawlqufny2itlcq', //sparks ipfs link
                          //image: widget.image,
                          title: widget.title,
                        ...
                        if (provider.state == WalletState.loading)
                          const Center(
                            child: EmptyWidget(text: 'Estimando tarifa de gas ...'),
                          )
