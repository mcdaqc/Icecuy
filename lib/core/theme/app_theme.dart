...
class AppTheme {
  ///LIGHT MODE
  ///
  static const Color _scaffoldColor = Color(0xff0b1d24);
  //static const Color _surfaceColor = Color(0xff091924);
  static const Color _surfaceColor = Color(0xff061418);

  static const Color _primaryColor = Color(0xffffffff);
  static const Color _secondaryColorLight = Color(0xffffffff);
